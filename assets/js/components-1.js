...
(function () {
        ...
        '<div class="ft-grid">' +
          ...
          '<div>' +
            ...
            '<ul class="ft-list">' +
              ...
              '<li><a href="' + base + 'pages/historico.html">Memória do corpo docente</a></li>' +
            '</ul>' +
          '</div>' +
          '<div>' +
  ...
  /* Escapa texto vindo de dado para interpolação em HTML. Estava duplicado
     dentro de producao-lattes.html; passa a viver aqui, onde qualquer página
     que monte HTML a partir de string possa usar. */
  function esc(t) {
  ...
  window.RC = {
    ...
    badge: badge, note: note, noteFonte: noteFonte, empty: empty, esc: esc,
